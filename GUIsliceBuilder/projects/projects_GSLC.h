...
enum {E_DRAW_LINE1,E_DRAW_LINE12,E_DRAW_LINE13,E_DRAW_LINE2
      ...
      ,E_ELEM_TEXT33,E_ELEM_TEXT34,E_ELEM_TEXT35,E_ELEM_TEXT37
      ,E_ELEM_TEXT38,E_ELEM_TEXT39,E_ELEM_TEXT4,E_ELEM_TEXT40
      ,E_ELEM_TEXT41,E_ELEM_TEXT42,E_ELEM_TEXT43,E_ELEM_TEXT44
      ,E_ELEM_TEXT45,E_ELEM_TEXT46,E_ELEM_TEXT47,E_ELEM_TEXT5
      ,E_ELEM_TEXT54,E_ELEM_TEXT55,E_ELEM_TEXT56,E_ELEM_TEXT58
      ,E_ELEM_TEXT59,E_ELEM_TEXT6,E_ELEM_TEXT60,E_ELEM_TEXT61
      ,E_ELEM_TEXT63,E_ELEM_TEXT64,E_ELEM_TEXT65,E_ELEM_TEXT66
      ,E_ELEM_TEXT67,E_ELEM_TEXT68,E_ELEM_TEXT69,E_ELEM_TEXT70
      ,E_ELEM_TEXT71,E_ELEM_TEXT73,E_ELEM_TEXT74,E_ELEM_TEXT75
      ,E_ELEM_TEXT76,E_ELEM_TEXT77,E_ELEM_TEXT78,E_ELEM_TEXT79
      ,E_ELEM_TEXT80,E_ELEM_TEXT81,E_ELEM_TEXT82,E_ELEM_TEXT83
      ,E_ELEM_TEXT84,E_ELEM_TEXT85,E_ELEM_TEXT86,E_ELEM_TEXT87
      ,E_ELEM_TEXT88,E_ELEM_TEXT89,E_ELEM_TEXT97,E_ELEM_TOGGLE2
...
#define MAX_ELEM_PG_SETTINGS_BALANCING 23 // # Elems total on page
...
extern gslc_tsElemRef* m_pElemOutTxt_BalancingStatus;
...
extern gslc_tsElemRef* m_pElemVal_SettingsBMS_TimerBMUPolling;
extern gslc_tsElemRef* m_pElemVal_SettingsBMS_TimerBMUPollingRemaining;
extern gslc_tsElemRef* m_pElemVal_SettingsBMS_TimerDisplayUpdate;
extern gslc_tsElemRef* m_pElemVal_SettingsBMS_TimerDisplayUpdateRemaining;
extern gslc_tsElemRef* m_pElemVal_SettingsBMS_TimerMemory;
extern gslc_tsElemRef* m_pElemVal_SettingsBMS_TimerMemoryRemaining;
extern gslc_tsElemRef* m_pElemVal_SettingsBMS_TimerSleep;
...
void InitGUIslice_gen(str_SystemData *pSystemData, LTC6810_Interface *ltc6810, str_SlaveBMUData *bmuData)
{
  ...
  static char m_sInputNumber8[10] = "";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_NUMINPUT_TIMERSLEEP,E_PG_SETTINGS_BMS,(gslc_tsRect){115,45,65,10},
    (char*)m_sInputNumber8,10,E_BUILTIN5X8);
  gslc_ElemSetTxtMargin(&m_gui,pElemRef,5);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  gslc_ElemSetClickEn(&m_gui, pElemRef, true);
  gslc_ElemSetTouchFunc(&m_gui, pElemRef, &CbBtnCommon);
  m_pElemVal_SettingsBMS_TimerSleep = pElemRef;
  ...
  static char m_sInputNumber9[10] = "";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_NUMINPUT_TIMERMEMORY,E_PG_SETTINGS_BMS,(gslc_tsRect){115,65,65,10},
    (char*)m_sInputNumber9,10,E_BUILTIN5X8);
  gslc_ElemSetTxtMargin(&m_gui,pElemRef,5);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  gslc_ElemSetClickEn(&m_gui, pElemRef, true);
  gslc_ElemSetTouchFunc(&m_gui, pElemRef, &CbBtnCommon);
  m_pElemVal_SettingsBMS_TimerMemory = pElemRef;
  
  // Create E_ELEM_NUMINPUT_TIMERDISPLAYUPDATE numeric input field
  static char m_sInputNumber10[10] = "";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_NUMINPUT_TIMERDISPLAYUPDATE,E_PG_SETTINGS_BMS,(gslc_tsRect){115,85,65,10},
    (char*)m_sInputNumber10,10,E_BUILTIN5X8);
  gslc_ElemSetTxtMargin(&m_gui,pElemRef,5);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  gslc_ElemSetClickEn(&m_gui, pElemRef, true);
  gslc_ElemSetTouchFunc(&m_gui, pElemRef, &CbBtnCommon);
  m_pElemVal_SettingsBMS_TimerDisplayUpdate = pElemRef;
  
  // Create E_ELEM_NUMINPUT_TIMERBMUPOLLING numeric input field
  static char m_sInputNumber11[10] = "";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_NUMINPUT_TIMERBMUPOLLING,E_PG_SETTINGS_BMS,(gslc_tsRect){115,105,65,10},
    (char*)m_sInputNumber11,10,E_BUILTIN5X8);
  gslc_ElemSetTxtMargin(&m_gui,pElemRef,5);
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  gslc_ElemSetClickEn(&m_gui, pElemRef, true);
  gslc_ElemSetTouchFunc(&m_gui, pElemRef, &CbBtnCommon);
  m_pElemVal_SettingsBMS_TimerBMUPolling = pElemRef;
  ...
  // Create E_ELEM_TEXT137 runtime modifiable text
  static char m_sDisplayText137[31] = "";
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT137,E_PG_SETTINGS_BALANCING,(gslc_tsRect){135,170,181,10},
    (char*)m_sDisplayText137,31,E_BUILTIN5X8);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_CYAN);
  m_pElemOutTxt_BalancingStatus = pElemRef;
