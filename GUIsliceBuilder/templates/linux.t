...
<STOP>
<IMAGE_PATH>
char m_strImgPath$<COUNT>[MAX_PATH];
<STOP>
<IMGBUTTON_PATH>
char m_strImgBtnPath$<COUNT>[MAX_PATH];
char m_strImgBtnSelPath$<COUNT>[MAX_PATH];
<STOP>
<INPUTFRAME_EN>
...
<LISTBOXSLIDER_2>
  ...
  gslc_ElemSetCol(&m_gui,pElemRef,$<BAR-116>,$<BAR-117>,$<BAR-117>);
...
<STOP>
<PROGRESSBARSTYLE>
  gslc_ElemXGaugeSetStyle(&m_gui,pElemRef, GSLCX_GAUGE_STYLE_PROG_BAR);
<STOP>
<RAMPGAUGE>
